...
public class TwitchService
    {
        ...
        TwitchService(IConfiguration configuration)
        {
        ...
        void Main(string[] args)
        {
            ...
            //run in async
            new TwitchService(_configuration)
                .MainAsync(args)
                .GetAwaiter()
                .GetResult();
        }
        ...
        {
            var channelId = _configuration["Twitch:ServiceChannelID"];

            //set up twitchlib api
            API = new TwitchAPI();
            API.Settings.ClientId = _configuration["Twitch:ServiceClientId"];
            API.Settings.Secret = _configuration["Twitch:ServiceApiKey"];
